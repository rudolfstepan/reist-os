...
X86_64_STARTUP_OBJ := $(X86_64_BOOTSTRAP_DIR)/startup_stack.o
X86_64_REQUEST_OBJ := $(X86_64_BOOTSTRAP_DIR)/request_admission.o
...
X86_64_TASK_FRAMES_OBJ := $(X86_64_BOOTSTRAP_DIR)/task_frames.o
X86_64_USER_ACCESS_OBJ := $(X86_64_BOOTSTRAP_DIR)/user_access.o
...
X86_64_NATIVE_PROGRAMS ?= 0
X86_64_PROGRAM_CASE ?= 0
...
# NativeNetworkSession: ordinary read-only shell plus isolated network roles.
X86_64_NATIVE_NETWORK_SESSION ?= 0
ifneq ($(words $(X86_64_NATIVE_NETWORK_SESSION)),1)
$(error NativeNetworkSession selector must be one value)
endif
ifneq ($(filter $(X86_64_NATIVE_NETWORK_SESSION),0 1),$(X86_64_NATIVE_NETWORK_SESSION))
$(error NativeNetworkSession selector must be 0 or 1)
endif
ifeq ($(X86_64_NATIVE_NETWORK_SESSION),1)
ifneq ($(X86_64_NATIVE_NETWORK_DMA)$(X86_64_NATIVE_APP_FILES),11)
$(error NativeNetworkSession requires NativeNetworkDMA and NativeAppFiles)
endif
ifneq ($(filter-out 0,$(X86_64_NATIVE_DISPLAY) $(X86_64_NATIVE_INPUT) $(X86_64_NATIVE_TERMINAL_SERVICE) $(X86_64_NATIVE_GRAPHICAL_SESSION)),)
$(error NativeNetworkSession excludes graphical profiles)
endif
endif
...
$(error NativeCppRuntime selector must be one value)
endif
ifneq ($(filter $(X86_64_NATIVE_CPP_RUNTIME),0 1),$(X86_64_NATIVE_CPP_RUNTIME))
$(error NativeCppRuntime selector must be 0 or 1)
endif
ifeq ($(X86_64_NATIVE_CPP_RUNTIME),1)
X86_64_NATIVE_APP_FILES := 1
endif
...
ifneq ($(filter $(X86_64_NATIVE_SESSION),0 1),$(X86_64_NATIVE_SESSION))
$(error NativeSession selector must be 0 or 1)
endif
ifeq ($(X86_64_NATIVE_SESSION),1)
ifneq ($(X86_64_NATIVE_SERVICE_CPU),1)
$(error NativeSession requires explicit device-free NativeServiceCPU)
endif
endif
...
ifneq ($(filter $(X86_64_NATIVE_SERVICE_CONSOLE),0 1),$(X86_64_NATIVE_SERVICE_CONSOLE))
$(error NativeServiceConsole selector must be 0 or 1)
endif
ifeq ($(X86_64_NATIVE_SERVICE_CONSOLE),1)
ifneq ($(X86_64_NATIVE_LIVE_FILE)$(X86_64_NATIVE_CONSOLE)$(X86_64_NATIVE_SHELL),100)
$(error NativeServiceConsole requires NativeLiveFile and excludes console-only fixtures)
endif
endif
...
ifneq ($(filter $(X86_64_NATIVE_SERVICE_PIO),0 1),$(X86_64_NATIVE_SERVICE_PIO))
$(error NativeServicePIO selector must be 0 or 1)
endif
ifeq ($(X86_64_NATIVE_SERVICE_PIO),1)
ifneq ($(X86_64_NATIVE_POOL_PIO)$(X86_64_NATIVE_SERVICE_CPU),10)
$(error NativeServicePIO requires NativePoolPIO and excludes NativeServiceCPU)
endif
endif
...
X86_64_NATIVE_LARGE_PERIODIC ?= 0
ifneq ($(words $(X86_64_NATIVE_LARGE_PERIODIC)),1)
$(error NativeLargePeriodic selector must be one value)
endif
ifneq ($(filter $(X86_64_NATIVE_LARGE_PERIODIC),0 1),$(X86_64_NATIVE_LARGE_PERIODIC))
$(error NativeLargePeriodic selector must be 0 or 1)
endif
ifeq ($(X86_64_NATIVE_LARGE_PERIODIC),1)
ifneq ($(X86_64_NATIVE_LARGE_IMAGE)$(X86_64_NATIVE_TASK_POOL)$(X86_64_NATIVE_SERVICE_CPU),111)
...
ifneq ($(filter $(X86_64_NATIVE_POOL_PIO),0 1),$(X86_64_NATIVE_POOL_PIO))
$(error NativePoolPIO selector must be 0 or 1)
endif
ifeq ($(X86_64_NATIVE_POOL_PIO),1)
...
ifneq ($(X86_64_NATIVE_POOL_PIO),1)
...
ifneq ($(X86_64_FILE_LAUNCH_CASE),0)
$(error FileLaunchCase requires NativeFileLaunch)
endif
endif
...
$(error NativeBlock requires NativePIO)
endif
endif
...
$(error NativeStartup requires NativeLifecycle and excludes FamilyCase)
endif
endif
ifneq ($(X86_64_STARTUP_CASE),0)
ifneq ($(X86_64_NATIVE_STARTUP),1)
$(error StartupCase requires NativeStartup)
endif
endif
ifeq ($(X86_64_NATIVE_LIFECYCLE),1)
ifneq ($(X86_64_NATIVE_PROGRAMS)$(X86_64_PROGRAM_CASE),10)
$(error NativeLifecycle requires NativePrograms and excludes ProgramCase)
endif
endif
ifneq ($(X86_64_FAMILY_CASE),0)
ifneq ($(X86_64_NATIVE_LIFECYCLE),1)
$(error FamilyCase requires NativeLifecycle)
endif
endif
...
ifneq ($(X86_64_NATIVE_RUNTIME)$(X86_64_NATIVE_IPC_CASE)$(X86_64_PROCESS_CASE)$(X86_64_C_PAYLOAD_PROBE)$(X86_64_C_INTEGRITY_PROBE),10000)
$(error NativePrograms requires NativeRuntime and excludes other native fixtures)
endif
else
ifneq ($(X86_64_PROGRAM_CASE),0)
$(error ProgramCase requires NativePrograms)
endif
endif
...
x86_64-cpp-runtime-media:
	@$(PYTHON) scripts/build_x86_64_cpp_runtime_media.py --input-directory "$(X86_64_CPP_RUNTIME_MEDIA_INPUT)" --output-directory "$(X86_64_CPP_RUNTIME_MEDIA_OUTPUT)" --nasm "$(AS)" --openssl "$(OPENSSL)"
...
ifeq ($(X86_64_NATIVE_PROGRAMS),1)
	...
	@$(X86_64_CC) $(X86_64_USER_CFLAGS) -Iuserspace/sdk/include \
		...
		-DX86_64_SHELL_EXIT_STATUS=$(X86_64_SHELL_EXIT_STATUS) \
		-DX86_64_OWNER_TERMINAL=$(X86_64_OWNER_TERMINAL) \
		$(if $(filter 1,$(X86_64_OWNER_TERMINAL)),-Oz,) \
...
ifeq ($(X86_64_NATIVE_DISPLAY),1)
	...
	@$(AS) -f elf32 $(X86_64_WIDE_ASM) -DX86_64_NATIVE_RAM=$(X86_64_NATIVE_RAM) arch/x86_64/mm/frame_claim.asm -o $(X86_64_FRAME_CLAIM_OBJ)
	@$(AS) -f elf32 arch/x86_64/proc/syscall_profile.asm -o $(X86_64_PROFILE_OBJ)
	@$(AS) -f elf32 $(X86_64_WIDE_ASM) -DX86_64_NATIVE_RAM=$(X86_64_NATIVE_RAM) arch/x86_64/exec/image_frames.asm -o $(X86_64_IMAGE_FRAMES_OBJ)
	@$(AS) -f elf32 $(X86_64_WIDE_ASM) -DX86_64_NATIVE_RAM=$(X86_64_NATIVE_RAM) arch/x86_64/mm/address_space.asm -o $(X86_64_ADDRESS_SPACE_OBJ)
	@$(AS) -f elf32 $(X86_64_WIDE_ASM) -DX86_64_NATIVE_RAM=$(X86_64_NATIVE_RAM) arch/x86_64/mm/task_frames.asm -o $(X86_64_TASK_FRAMES_OBJ)
	@$(AS) -f elf32 $(X86_64_WIDE_ASM) -DX86_64_NATIVE_RAM=$(X86_64_NATIVE_RAM) arch/x86_64/mm/user_access.asm -o $(X86_64_USER_ACCESS_OBJ)
...
SYSTEM_IMAGE_FILES := \
	...
	bin/fwritest.prg=$(SYSTEM_PROGRAM_DIR)/FWRITEST.PRG \
	...
	usr/bin/jstest.prg=$(SYSTEM_PROGRAM_DIR)/JSTEST.PRG \
	usr/bin/jswork.prg=$(SYSTEM_PROGRAM_DIR)/JSWORK.PRG \
	usr/bin/jsipctst.prg=$(SYSTEM_PROGRAM_DIR)/JSIPCTST.PRG \
	...
	htdocs/jsargs.js=htdocs/jsargs.js \
	htdocs/jsmath.js=htdocs/jsmath.js \
	htdocs/jsjson.js=htdocs/jsjson.js \
	htdocs/jserror.js=htdocs/jserror.js \
	htdocs/jssafe.js=htdocs/jssafe.js \
	htdocs/jsread.js=htdocs/jsread.js \
	htdocs/mandel.js=htdocs/mandel.js \
	htdocs/mandelc.js=htdocs/mandelc.js \
	htdocs/jscolors.js=htdocs/jscolors.js \
