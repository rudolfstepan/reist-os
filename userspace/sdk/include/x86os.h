...
#define X86OS_STORAGE_CHECK_FAT12 11U
#define X86OS_STORAGE_REPAIR_FAT12_MIRROR 12U
#define X86OS_STORAGE_REPAIR_FAT12_CHAINS 13U
#define X86OS_STORAGE_REPAIR_FAT12_SHORT_FILES 14U
#define X86OS_STORAGE_RECLAIM_FAT12_ORPHANS 15U
#define X86OS_STORAGE_REPAIR_FAT12_LOOPS 16U
#define X86OS_STORAGE_REPAIR_FAT12_DIRECTORY_LOOPS 17U
#define X86OS_STORAGE_REPAIR_FAT12_SHORT_LOOPS 18U
#define X86OS_STORAGE_REPAIR_FAT12_CROSSLINKS 19U
#define X86OS_STORAGE_REPAIR_FAT12_DIRECTORY_SIZE 20U
#define X86OS_STORAGE_REPAIR_FAT12_VOLUME_LABEL 21U
#define X86OS_STORAGE_REPAIR_FAT12_ZERO_FILES 22U
#define X86OS_STORAGE_REPAIR_FAT12_ZERO_START_FILES 23U
#define X86OS_STORAGE_REPAIR_FAT12_DOT_SIZE 24U
#define X86OS_STORAGE_REPAIR_FAT12_DOT_CLUSTER 25U
#define X86OS_STORAGE_REPAIR_FAT12_REQUIRED_CROSSLINKS 26U
#define X86OS_STORAGE_REPAIR_FAT12_DIRECTORY_CROSSLINKS 27U
...
#define X86OS_FAT12_RESULT_MIRROR_REPAIRED (1U << 3)
#define X86OS_FAT12_RESULT_CHAIN_INVALID (1U << 4)
#define X86OS_FAT12_RESULT_CHAIN_LOOP (1U << 5)
#define X86OS_FAT12_RESULT_CHAIN_CROSSLINK (1U << 6)
#define X86OS_FAT12_RESULT_CHAIN_SHORT (1U << 7)
#define X86OS_FAT12_RESULT_CHAIN_EXCESS (1U << 8)
#define X86OS_FAT12_RESULT_ORPHAN_CLUSTER (1U << 9)
#define X86OS_FAT12_RESULT_DIRECTORY_INVALID (1U << 10)
#define X86OS_FAT12_RESULT_SCAN_LIMIT (1U << 11)
#define X86OS_FAT12_RESULT_CHAINS_REPAIRED (1U << 12)
#define X86OS_FAT12_RESULT_SHORT_FILES_REPAIRED (1U << 13)
#define X86OS_FAT12_RESULT_ORPHANS_RECLAIMED (1U << 14)
#define X86OS_FAT12_RESULT_LOOPS_REPAIRED (1U << 15)
#define X86OS_FAT12_RESULT_DIRECTORY_LOOPS_REPAIRED (1U << 16)
#define X86OS_FAT12_RESULT_SHORT_LOOPS_REPAIRED (1U << 17)
#define X86OS_FAT12_RESULT_CROSSLINKS_REPAIRED (1U << 18)
#define X86OS_FAT12_RESULT_DIRECTORY_SIZE_REPAIRED (1U << 19)
#define X86OS_FAT12_RESULT_VOLUME_LABEL_REPAIRED (1U << 20)
#define X86OS_FAT12_RESULT_ZERO_FILES_REPAIRED (1U << 21)
#define X86OS_FAT12_RESULT_ZERO_START_FILES_REPAIRED (1U << 22)
#define X86OS_FAT12_RESULT_DOT_SIZE_REPAIRED (1U << 23)
#define X86OS_FAT12_RESULT_DOT_CLUSTER_REPAIRED (1U << 24)
#define X86OS_FAT12_RESULT_REQUIRED_CROSSLINKS_REPAIRED (1U << 25)
#define X86OS_FAT12_RESULT_DIRECTORY_CROSSLINKS_REPAIRED (1U << 26)
#define X86OS_FAT12_RESULT_DIRECTORY_TOPOLOGY_REPAIRED (1U << 27)
#define X86OS_FAT12_RESULT_ORPHANS_SALVAGED (1U << 28)
#define X86OS_FAT12_RESULT_BAD_SECTOR_REMAPPED (1U << 29)
...
#define X86OS_VFS_SHADOW_OBJECT_OPEN 8U
...
typedef struct {
    ...
    x86os_file_info_t info;
    uint32_t reserved[3];
} x86os_vfs_shadow_object_frame_t;
...
#define X86OS_DEVICE_DMA_LARGE_POOL_BYTES (512U * 1024U)
...
enum {
    ...
    X86OS_DEVICE_CONTROL_NATIVE_PIO = 29U,
};
enum {
...
enum {
    ...
    X86OS_DEVICE_DRIVER_REPORT_STARTUP_PROGRESS = 5U,
};
enum {
