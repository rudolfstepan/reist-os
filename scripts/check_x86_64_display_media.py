"""Independent signed-media consumer for the opt-in native display profile."""
...
selected=clone(legacy,[
 ("PROFILE='research-native-shell-two-media-v1'","PROFILE='research-native-display-two-media-v1'"),
 ...
 ("directory/'shell-media.json'","directory/'display-media.json'"),
 ...
 ("data_volume(bounded(attempt/'system.ext2',131072),values['file-program.prg'])",
  "data_volume(bounded(attempt/'system.ext2',1048576),values)")],'reist_display_consumer')
...
if __name__=='__main__':
    ...
    print('DISPLAY_MEDIA_VERIFY_OK',verify(a.directory,a.index,a.openssl))
