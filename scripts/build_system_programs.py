...
PROGRAMS = {
    ...
    "JSWORK.PRG": (ROOT / "userspace/js/js_worker.c", ROOT / "userspace/js/js_protocol.c",
                   ROOT / "userspace/js/script_protocol.c",ROOT / "userspace/js/file_protocol.c",ROOT / "userspace/js/file_worker.c"),
    "JS.PRG": (ROOT / "userspace/programs/js.cpp", ROOT / "userspace/js/runner.cpp",
        ROOT / "userspace/js/file_protocol.c",ROOT / "userspace/js/file_broker.cpp",
