...
selected=check.clone(legacy,[
 ('scripts/check_x86_64_shell_media.py','scripts/check_x86_64_terminal_service_media.py'),
 ("output/'shell-media.json'","output/'terminal-service-media.json'"),
 ...
 ("'REIST native shell: bounded two-medium RESEARCH profile, not a finished OS/release.\\n'",
  "'REIST native64 TERMINAL SERVICE research profile; isolated PS2 driver and bounded consumer.\\n'"),
 ("'system.ext2 is the separate primary ATA master, read-only, containing /boot.prg.\\n'",
  "'system.ext2: read-only primary master; /boot.prg is the explicit input/display client.\\n'")],
 'reist_terminal_service_producer')
