...
def default_sources():
    ...
    for name in names:
        ...
        for macro in ('REIST_NATIVE_GRAPHICAL_SESSION','REIST_NATIVE_TERMINAL_SERVICE','REIST_NATIVE_INPUT','REIST_NATIVE_DISPLAY','REIST_NATIVE_SHELL_SESSION','REIST_NATIVE_SESSION','REIST_NATIVE_TERMINAL'):
