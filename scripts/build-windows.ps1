...
try {
    ...
    $imageDataArguments += @(
        ...
        '--data-file', "usr/share/fonts/reist-unicode.psf=$(Join-Path $RepoRoot 'assets\fonts\reist-unicode.psf')"
        '--data-file', "usr/share/fonts/reist-jetbrains-mono.psf=$(Join-Path $RepoRoot 'assets\fonts\reist-jetbrains-mono.psf')"
        '--data-file', "usr/share/fonts/reist-source-code-pro.psf=$(Join-Path $RepoRoot 'assets\fonts\reist-source-code-pro.psf')"
        '--data-file', "usr/share/fonts/reist-iosevka.psf=$(Join-Path $RepoRoot 'assets\fonts\reist-iosevka.psf')"
        '--data-file', "usr/share/fonts/reist-fira-code.psf=$(Join-Path $RepoRoot 'assets\fonts\reist-fira-code.psf')"
        '--data-file', "usr/share/fonts/catalog.toml=$(Join-Path $RepoRoot 'assets\fonts\catalog.toml')"
        '--data-file', "usr/share/fonts/unifont_all-16.0.04.hex.gz=$(Join-Path $RepoRoot 'assets\fonts\source\unifont_all-16.0.04.hex.gz')"
        '--data-file', "usr/share/fonts/ofl-1.1.txt=$(Join-Path $RepoRoot 'assets\fonts\source\OFL-1.1.txt')"
        '--data-file', "usr/share/fonts/jetbrains-mono-ofl.txt=$(Join-Path $RepoRoot 'assets\fonts\source\jetbrains-mono\OFL.txt')"
        '--data-file', "usr/share/fonts/source-code-pro-ofl.txt=$(Join-Path $RepoRoot 'assets\fonts\source\source-code-pro\OFL.txt')"
