...
selected=check.clone(legacy,[
 ('scripts/check_x86_64_shell_media.py','scripts/check_x86_64_input_media.py'),
 ("output/'shell-media.json'","output/'input-media.json'"),
 ...
 ("'REIST native shell: bounded two-medium RESEARCH profile, not a finished OS/release.\\n'",
  "'REIST native64 INPUT research profile; isolated PS2 driver and bounded consumer.\\n'"),
