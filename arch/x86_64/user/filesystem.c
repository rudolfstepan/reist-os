...
#define reist_native_service_dispatch_profile reist_native_service_dispatch_profile_v2
#define reist_fs_server reist_fs_server_v2
#define reist_fs_server_init reist_fs_server_init_v2
#define reist_fs_dispatch reist_fs_dispatch_v2
#define reist_fs_server_fence reist_fs_server_fence_v2
#endif
