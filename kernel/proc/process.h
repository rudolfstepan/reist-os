...
#define PROCESS_ARGUMENT_STRING_BYTES 8193U
#define PROCESS_ARGUMENT_TOTAL_BYTES 16384U
...
/* Exclusive upper bound; TASK_CONTROL132 is native-only, not an i386 grant. */
#define PROCESS_DOMAIN_SYSCALL_LIMIT 133U
